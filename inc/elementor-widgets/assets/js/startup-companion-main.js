(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".startup-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".startup-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".startup-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.startup-startup').imagesLoaded(function () {
            // filter items on button click
            $('.startup-menu').on('click', 'p', function () {
            ...
            // init Isotope
            var $grid = $('.startup-startup').isotope({
    ...
    $('.startup-menu button.btn').on('click', function () {
        $('.startup-menu button.btn').removeClass('active');
    ...
    // MC Scripts
    var $subscribe = $('.startup-subscribe-newsletter-area');
    if ($subscribe.length) {
