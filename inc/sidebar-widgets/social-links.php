...
class Startup_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Startup ] Social Links', 'startup-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'startup-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'startup-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'startup-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'startup-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'startup-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'startup-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'startup-companion'); ?></label>
...
} // Class startup_social_links ends here


// Register and load the widget
function startup_social_links_widget_load() {
	register_widget( 'Startup_social_links' );
}
add_action( 'widgets_init', 'startup_social_links_widget_load' );